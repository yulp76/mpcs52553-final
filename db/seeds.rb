...
attractions = [
  {
    ...
    "destination" => "Chicago",
    "type" => "Museums",
    "image_url" => "https://travel.usnews.com/static-travel/images/destinations/2/art_institute_of_chicago_new.jpg",
  ...
  },
  {
    ...
    "destination" => "Chicago",
    "type" => "Nature & Parks",
    "image_url" => "https://travel.usnews.com/static-travel/images/destinations/2/chicago_getty_tetra_images.jpg",
  ...
  },
  {
    ...
    "destination" => "Chicago",
    "type" => "Zoos & Aquariums",
    "image_url" => "https://chicagotonight.wttw.com/sites/default/files/styles/full/public/article/image-non-gallery/3U8A8132%20%282%29.jpg?itok=reJd4bBU",
...
attractions.each do |attraction|
  ...
  a.type_id = Type.find_by(name: attraction["type"]).id
